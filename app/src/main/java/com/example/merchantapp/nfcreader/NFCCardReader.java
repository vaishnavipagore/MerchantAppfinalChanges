...
public class NFCCardReader  {
     ...
     * @param intent intent with initial card information.
     */
//    public Single<EmvCard> readCardRx2(final Intent intent) {
//        return readCardRx2(intent, schedulers.Schedulers.io());
//    }
     ...
     * @param scheduler scheduler for operating
     */
    public Single<EmvCard> readCardRx2(final Intent intent,Scheduler scheduler) {
        return Single.
                fromCallable(new Callable<EmvCard>() {
                    @Override
                    public EmvCard call() throws Exception {
