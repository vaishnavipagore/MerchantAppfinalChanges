...
import com.example.merchantapp.nfcutils.BitUtils;
import com.example.merchantapp.nfcutils.BytesUtils;
import com.example.merchantapp.nfcutils.EnumUtils;
...
public class Service extends AbstractData{
	...
	public Service(final String pData) {
		if (pData != null && pData.length() == 3) {
			BitUtils bit = new BitUtils(BytesUtils.fromString( com.example.merchantapp.nfcmodel.CommonsUtils.rightPad(pData, 4, "0")));
