...
public class HomeActivity extends AppCompatActivity {
    ...
    String mobile;
    String MerchantName;
    Button salebtn,logoutbtn,historybtn,voidbtn,preauthbtn,preauthcbtn,salewithcash,BQRbtn,nfcbutton;
    String FCMToken;
    ...
    private void jsonParse() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                System.out.println("getResponse ::1 "+ response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                System.out.println("getResponse ::3 "+ error.getMessage());
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                System.out.println("getResponsew Params  Home: "+ headers);
